...
<div class='find-place' :class='{centered: boxInTheMiddle }'>
  <div v-if='boxInTheMiddle'>
    ...
    <p class='description'>ca：9fH6JGanvkYtGwrBQ7vieT4vy4jw6i6uPEfstXRppump</p>
  </div>
  ...
  <div v-if='showWarning' class='prompt message note shadow'>
    Note: Large cities may require 200MB+ of data transfer and may need a powerful device to render.ca：9fH6JGanvkYtGwrBQ7vieT4vy4jw6i6uPEfstXRppump
  </div>
